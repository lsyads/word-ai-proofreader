...
3. 在任务窗格选择“当前选区”，填写“书名”，书籍介绍可选。
4. 试点优先保守时，展开“高级设置”，把“写回模式”改为“批注模式”。
5. 点击“开始审校”。
6. 审校完成后，确认任务窗格显示候选问题；没有候选时应显示“未发现需要确认的问题”。
7. 点击单条候选的“定位”，确认 Word 能选中对应原文。
8. 逐条“批准”或“拒绝”候选；也可用“批准全部/拒绝全部”处理所有待确认候选。
9. 点击“写回已批准”，确认 Word 只写回已批准候选。
10. 切换到“全书 DOCX”来源时，选择 `.docx` 文件后重复审校；批准候选并点击“写回已批准”后，再点击“下载结果 DOCX”。

验收通过标准：

- 任务窗格能打开。
- 后端 `/health` 返回 `{"status":"ok"}`。
- 当前选区或 DOCX 审校能返回候选问题，或明确提示未发现需要确认的问题。
- 可定位问题点击“定位”后能选中原文。
- 批注模式不会直接改正文。
- 点击“写回已批准”后只写入已批准候选。
